...
import '../../widgets/media_gallery.dart'; // ✅ Import du widget MediaGallery
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  // ========== POST CARD AVEC CARROUSEL (MediaGallery) ==========
  Widget _buildPostCard(Post post) {
    ...
    if (post.mediaGallery != null && post.mediaGallery!.isNotEmpty) {
    ...
    if (post.mediaTypes != null && post.mediaTypes!.isNotEmpty) {
      mediaTypes = post.mediaTypes!;
    } else {
      // Si aucun type n'est fourni, on suppose que ce sont des images
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ✅ Carrousel des médias avec MediaGallery
...
class _FilterSheetState extends State<_FilterSheet> {
  ...
  Widget _noDataHint(String text) => Text(text, style: TextStyle(color: Colors.grey[400], fontSize: 12.5));
