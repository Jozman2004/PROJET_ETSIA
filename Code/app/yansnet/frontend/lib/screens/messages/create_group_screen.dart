                          ...
                          return ListTile(
                            leading: CircleAvatar(
                              backgroundColor: isMutual
                                  ? const Color(0xFF9E1B22).withOpacity(0.1)
                                  : Colors.grey[300],
                              child: Text(
                                user.displayName[0].toUpperCase(),
                                style: TextStyle(
                                  color: isMutual ? const Color(0xFF9E1B22) : Colors.grey[600],
                                ),
                              ),
                            ),
                            title: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: isMutual ? Colors.black : Colors.grey[600],
                              ),
                            ),
                            subtitle: Text(
                              '@${user.username}',
                            ...
                            trailing: Checkbox(
                              value: isSelected && isMutual,
                              onChanged: isMutual ? (_) => _toggleSelection(user) : null,
                              activeColor: const Color(0xFF9E1B22),
                              materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                            ),
                            onTap: isMutual ? () => _toggleSelection(user) : null,
                            enabled: isMutual,
                          );
                        },
                      ),
